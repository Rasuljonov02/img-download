...
<template>
  <div class="small-contaimner">
    <div class="container">
      ...
      <div v-if="dataINS" class="products">
        <div v-for="(img, i) in dataINS?.photos" :key="i" class="products-col">
          <div class="img-wrapper">
            ...
            <a
              class="download-icon"
              :download="getDownloadFileName(img.src.landscape)"
              title="Download"
              :href="getDownloadFileName(img.src.landscape)"
            >
      ...
      <!--      <a-button v-if="dataINS?.photos.length > 0" class="clear-btn" @click="clearData" type="primary">Ma'lumotlarni-->
      <!--        tozalash-->
      <!--      </a-button>-->
